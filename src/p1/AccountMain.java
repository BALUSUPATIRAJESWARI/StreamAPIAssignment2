...
public class AccountMain {
	...
	public static void main(String[] args) {
		...
		Account a1 = new Account(10101, "Rajeswari", 7000, "Hyderabad");
		Account a2 = new Account(10112, "Manikanta", 12000, "Guntur");
		Account a3 = new Account(10123, "Manasa", 5400, "Gujarath");
		Account a4 = new Account(11234, "Ganga", 9000, "Delhi");
		Account a5 = new Account(10100, "chiinni", 8993, "Krosur");
		Account a6 = new Account(10140, "Nagalakshmi", 88000, "Hyderabad");
